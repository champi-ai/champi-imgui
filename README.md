...
```json
{
  "mcpServers": {
    "champi-imgui": {
      ...
      "args": [
        "--from",
        "https://github.com/champi-ai/champi-imgui/releases/download/v1.10.0/champi_imgui-1.10.0-py3-none-any.whl",
        "champi-imgui",
        "serve"
      ]
    }
...
uvx --from https://github.com/champi-ai/champi-imgui/releases/download/v1.10.0/champi_imgui-1.10.0-py3-none-any.whl champi-imgui serve

# Install as a persistent tool
uv tool install https://github.com/champi-ai/champi-imgui/releases/download/v1.10.0/champi_imgui-1.10.0-py3-none-any.whl
champi-imgui serve

# Add to a project
uv add https://github.com/champi-ai/champi-imgui/releases/download/v1.10.0/champi_imgui-1.10.0-py3-none-any.whl
```
